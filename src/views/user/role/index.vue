<template> 
  <div class="app-container">
      ...
      <el-table ref="roleTable" :data="list" style="width: 100%;" v-loading="listLoading" border>
        ...
        <el-table-column label="操作" width="300" align="center">
          <template slot-scope="scope">
            ...
            <el-button icon="el-icon-reset" type="info" size="mini" @click="handleViewPermission(scope.$index, scope.row)" v-if="scope.row.name != 'super_admin'">权限设置</el-button>
    ...
    <el-dialog title="权限设置" :visible.sync="selectDialogVisible" width="35%" :close-on-click-modal="false">
      <el-tree :data="dialogData.list" :props="dialogData.defaultProps" ref="tree" :current-node-key="dialogData.checkedList" node-key="name" :check-strictly="checkStrictly" :default-expanded-keys="dialogData.defaultCheckedList" :default-checked-keys="dialogData.defaultCheckedList" show-checkbox>
      </el-tree>
      <div slot="footer">
